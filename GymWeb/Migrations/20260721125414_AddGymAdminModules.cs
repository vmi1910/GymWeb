...
{
    public partial class AddGymAdminModules : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TrainerProfiles", x => x.StaffID);
                    table.ForeignKey(
                        name: "FK_TrainerProfiles_Staffs_StaffID",
                        column: x => x.StaffID,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Subscriptions_MembershipPackages_PackageID",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_StaffSchedules_Rooms_RoomID",
                        column: x => x.RoomID,
